<x-layout>
    ...
    <section class="min-w-screen min-h-screen bg-white flex items-center justify-center px-5 py-5">
        <div class="bg-white text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
            <div class="md:flex w-full">
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    ...
                    <div>
                        @if (session('status'))
                            <div class="bg-red-400 text-gray-900 p-3 my-3 text-center rounded">{{ session('status') }}
                            </div>
                        @endif
                    </div>
