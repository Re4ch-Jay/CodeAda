<x-layout>
    ...
    <section class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
                        ...
                        <form action="{{route("register")}}" method="POST">
                                ...
                                <div class="w-1/2 px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input
                                            ...
                                            name="last_name"
                                            value="{{old('first_name')}}"
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith">
                                    </div>
                                ...
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input
                                            ...
                                            name="email"
                                            value="{{old('email')}}"
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com">
                                    </div>
                                    @error('email')
                                        <div class="text-red-400 font-bold text-xs">{{$message}}</div>
                                    @enderror
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-12">
                                    ...
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                        <input type="password" name="password_confirmation" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
