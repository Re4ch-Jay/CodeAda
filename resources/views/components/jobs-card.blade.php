...
<div id="list" class="relative flex flex-col items-center justify-center overflow-hidden sm:py-4">
    ...
    <div
        ...
        <div>
            <a href="{{ route('careers.show', $career) }}"
                class="bg-purple-900 text-white font-medium px-4 py-2 rounded-md flex gap-1 items-center">Read More
